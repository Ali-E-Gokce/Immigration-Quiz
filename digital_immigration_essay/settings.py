"""
Django settings for digital_immigration_essay project.
...
ROOT_URLCONF = 'digital_immigration_essay.urls'
...
WSGI_APPLICATION = 'digital_immigration_essay.wsgi.application'
